...
import com.example.mylibrary.channellist.view.ChannelController;
import com.example.user.myapplication.rxtest.adapter.DataAdapter;
import com.example.user.myapplication.rxtest.model.Android;
import com.example.user.myapplication.rxtest.network.RequestInterface;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initRecyclerView() {
        ...
        ChannelController channelController = new ChannelController() {
            @Override
            protected void allChannelList(ArrayList<ChannelModel> channelModels) {
